<?php
$products = [
    ["name" => "SOFA 1", "image" => "h1.PNG", "price" => 599.99, "category" => "sofas", "availability" => "Out of Stock"],
    ["name" => "SOFA 2", "image" => "h2.PNG", "price" => 1100, "category" => "sofas", "availability" => "In Stock"],
    ["name" => "MUEBLE 1", "image" => "h3.PNG", "price" => 200, "category" => "muebles", "availability" => "In Stock"],
    ["name" => "SILLON 1", "image" => "h4.PNG", "price" => 199.99, "category" => "sillones","availability" => "In Stock"],
    ["name" => "SILLON 2", "image" => "h5.PNG", "price" => 150, "category" => "sillones", "availability" => "In Stock"],
    ["name" => "MUEBLE 2", "image" => "h6.PNG", "price" => 250, "category" => "muebles", "availability" => "Out of Stock"]
];
...
<body>
    ...
    <main>
        ...
        <div class="animated flash">
            <h5>¡15% de descuento en Sofas!</h5>
        </div>
        <br>
