<?php
$products = [
    ["name" => "TRAJE IMAGINARIO 1", "image" => "r5.PNG", "price" => 9999.99, "category" => "trajes", "availability" => "Out of Stock"],
    ["name" => "SUDADERA 1", "image" => "r1.PNG", "price" => 5.99, "category" => "sudaderas", "availability" => "In Stock"],
    ["name" => "TRAJE 1", "image" => "r2.PNG", "price" => 24.99, "category" => "trajes", "availability" => "In Stock"],
    ["name" => "CAMISA 1", "image" => "r4.PNG", "price" => 9.99, "category" => "camisas", "availability" => "In Stock"],
    ["name" => "CAMISETA 1", "image" => "r3.PNG", "price" => 4.99, "category" => "camisetas", "availability" => "In Stock"],
    ["name" => "CAMISETA 2", "image" => "r6.PNG", "price" => 7.99, "category" => "camisetas", "availability" => "Out of Stock"]
];
...
<body>
    ...
    <main>
        ...
        <div class="animated flash">
            <h5>¡35% de descuento en Trajes!</h5>
        </div>
        <br>
