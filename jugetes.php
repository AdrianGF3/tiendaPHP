<?php
$products = [
    ["name" => "OTROS 1", "image" => "j5.PNG", "price" => 4.99, "category" => "otros", "availability" => "Out of Stock"],
    ["name" => "MUÑECO 1", "image" => "j1.PNG", "price" => 9.99, "category" => "muñecos", "availability" => "In Stock"],
    ["name" => "OTROS 2", "image" => "j2.PNG", "price" => 15, "category" => "otros", "availability" => "In Stock"],
    ["name" => "MUÑECO 2", "image" => "j4.PNG", "price" => 15, "category" => "muñecos", "availability" => "In Stock"],
    ["name" => "OTROS 2", "image" => "j3.PNG", "price" => 12.99, "category" => "otros", "availability" => "In Stock"],
    ["name" => "OTROS 3", "image" => "j6.PNG", "price" => 7.99, "category" => "otros", "availability" => "Out of Stock"]
];
...
<body>
    ...
    <main>
        ...
        <div class="animated flash">
            <h5>¡45% de descuento en Otros jugetes!</h5>
        </div>
        <br>
